					...
					<div class="row">
						<div class="col-md-3 col-xs-6">
							<div class="footer">
								...
								<p>This is my mini project</p>
								<ul class="footer-links">
									<li><a href="#"><i class="fa fa-map-marker"></i>Columbus,Ohio</a></li>
									<li><a href="#"><i class="fa fa-phone"></i>6145667899</a></li>
									<li><a href="#"><i class="fa fa-envelope-o"></i>heyi252@gmail.com</a></li>
								</ul>
							</div>
						</div>
